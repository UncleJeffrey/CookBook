...
async function UpdateAbl(req, res) {
    let {id, name, description, ingredientList, ingredientMap ? ingredientMap :} = req.body;
    if (
        ...
        const recipe = {id, name, description, ingredientList, ingredientMap ? ingredientMap :};
        try {
